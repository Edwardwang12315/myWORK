...
parser.add_argument('-na', '--no-animation', help="no animation is shown.", action="store_false")
...
GT_PATH = '/home/share/lowdetect/dataset/DarkFace/label/'
DR_PATH = '../result/annotations/'
